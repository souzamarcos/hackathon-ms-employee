...
sonarqube {
	properties {
		property("sonar.exclusions", "**/entity/**,**/secret/**,**/*Configuration.java,**/*Model.java,**/*Dto.java,**/ExceptionHandlerApi.java,**/HealthApi.java,**/ExceptionHttpResponse.java,**/BurgerApplication.java,**/exception/**,**/InMemory*")
	}
}
